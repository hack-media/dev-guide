...
.header .main-menu li ul li a {
  ...
  background: url(../imgs/template/icons/icon-menu.svg) no-repeat left 20px
    center;
  transition: 0.2s;
}
.header .main-menu li ul li a:hover {
  transition: 0.2s;
  background: url(../imgs/template/icons/icon-menu-hover.svg) no-repeat left
    20px center;
}
